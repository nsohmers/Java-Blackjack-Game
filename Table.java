...
public class Table extends JPanel implements MouseListener, MouseMotionListener {
  ...
  private int getPlayerCardValue() {
    ...
    for (int i = 0; i < playerCards.size(); i++) {
      ...
      if (playerCards.get(i).isAce() && !(playerCards.get(i).isHidden()))
        hasAce = true;
    }
  ...
  private int getDealerCardValue() {
    ...
    for (int i = 0; i < dealerCards.size(); i++) {
      ...
      if (dealerCards.get(i).isAce() && !(dealerCards.get(i).isHidden()))
        hasAce = true;
    }
    if (total + 10 <= 21 && hasAce) {
      total += 10;
  ...
  public void paintComponent(Graphics g) {
    ...
    newGameButtonX = 800 - (int) (buttonSize * 1.8);
    ...
    if (showGameButtons) {
      ...
      g.drawString("Hit", (hitButtonX + (buttonSize / 2)) - (g.getFontMetrics().stringWidth("Hit") / 2),
          ((hitButtonY + (buttonSize / 2)) + (g.getFontMetrics().getHeight() / 2))
      ...
      g.drawString("Stand", standButtonX + g.getFontMetrics().stringWidth("i"),
          ((standButtonY + (buttonSize / 2)) + (g.getFontMetrics().getHeight() / 2))
              - g.getFontMetrics().getHeight() / 4);
    }
    ...
    g.drawString("New", (newGameButtonX + (buttonSize / 2)) - (g.getFontMetrics().stringWidth("New") / 2),
        ((newGameButtonY + (buttonSize / 2)) + (g.getFontMetrics().getHeight() / 2))
            - (g.getFontMetrics().getHeight() / 4) * 3);

    g.drawString("Game", (newGameButtonX + (buttonSize / 2)) - (g.getFontMetrics().stringWidth("Game") / 2),
        ((newGameButtonY + (buttonSize / 2)) + (g.getFontMetrics().getHeight() / 2))
            + (g.getFontMetrics().getHeight() / 8));
  ...
  public void mousePressed(MouseEvent e) {
    ...
    if (x >= newGameButtonX && x <= newGameButtonX + buttonSize && y >= newGameButtonY
        && y <= newGameButtonY + buttonSize) {
    ...
    if ((x >= hitButtonX && x <= hitButtonX + buttonSize && y >= hitButtonY && y <= hitButtonY + buttonSize)
        && showGameButtons) {
    ...
    if ((x >= standButtonX && x <= standButtonX + buttonSize && y >= standButtonY && y <= standButtonY + buttonSize)
        || this.getPlayerCardValue() == 21 && showGameButtons) {
